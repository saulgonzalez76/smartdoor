...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h3>SmartDoor.mx</h3>";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Guardando credenciales<br/>Tratando de conectar SmartDoor a la red WiFi.<br />Si no se puede conectar, por favor intente de nuevo.</div>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>Conectado</strong> a {v}<br/><em><small> IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>No conectado</strong> a {v}{r}</div>";
const char HTTP_STATUS_OFFPW[]     PROGMEM = "<br/>Error de autenticacion"; // STATION_WRONG_PASSWORD,  no eps32
...
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>Ningun AP activo</div>";
