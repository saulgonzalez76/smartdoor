...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(c,e,d){c instanceof String&&(c=String(c));for(var f=c.length,a=0;a<f;a++){var b=c[a];if(e.call(d,b,a,c))return{i:a,v:b}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
...
this.showWidgetOnAddonClick=b.showWidgetOnAddonClick;this.icons=b.icons;this.maxHours=b.maxHours;this.explicitMode=b.explicitMode;this.handleDocumentClick=function(a){var b=a.data.scope;b.$element.parent().find(a.target).length||b.$widget.is(a.target)||b.$widget.find(a.target).length||b.hideWidget()};this._init()};f.prototype={constructor:f,_init:function(){var a=this;if(this.showWidgetOnAddonClick&&this.$element.parent().hasClass("input-group")&&this.$element.parent().hasClass("bootstrap-timepicker"))this.$element.parent(".input-group.bootstrap-timepicker").find(".input-group-addon").on({"click.timepicker":c.proxy(this.showWidget,
...
case "minute":this.decrementMinute();this.highlightMinute();break;case "second":this.decrementSecond();this.highlightSecond();break;case "meridian":this.toggleMeridian(),this.highlightMeridian()}this.update()}},getCursorPosition:function(){var a=this.$element.get(0);if("selectionStart"in a)return a.selectionStart;if(d.selection){a.focus();var b=d.selection.createRange(),c=d.selection.createRange().text.length;b.moveStart("character",-a.value.length);return b.text.length-c}},getTemplate:function(){if(this.showInputs){var a=
'<input type="text" class="bootstrap-timepicker-hour" maxlength="2"/>';var b='<input type="text" class="bootstrap-timepicker-minute" maxlength="2"/>';var c='<input type="text" class="bootstrap-timepicker-second" maxlength="2"/>';var g='<input type="text" class="bootstrap-timepicker-meridian" maxlength="2"/>'}else a='<span class="bootstrap-timepicker-hour"></span>',b='<span class="bootstrap-timepicker-minute"></span>',c='<span class="bootstrap-timepicker-second"></span>',g='<span class="bootstrap-timepicker-meridian"></span>';
...
this.icons.up+'"></span></a></td>':"")+"</tr><tr><td>"+a+'</td> <td class="separator">:</td><td>'+b+"</td> "+(this.showSeconds?'<td class="separator">:</td><td>'+c+"</td>":"")+(this.showMeridian?'<td class="separator">&nbsp;</td><td>'+g+"</td>":"")+'</tr><tr><td><a href="#" data-action="decrementHour"><span class="'+this.icons.down+'"></span></a></td><td class="separator"></td><td><a href="#" data-action="decrementMinute"><span class="'+this.icons.down+'"></span></a></td>'+(this.showSeconds?'<td class="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><span class="'+
this.icons.down+'"></span></a></td>':"")+(this.showMeridian?'<td class="separator">&nbsp;</td><td><a href="#" data-action="toggleMeridian"><span class="'+this.icons.down+'"></span></a></td>':"")+"</tr></table>";switch(this.template){case "modal":var d='<div class="bootstrap-timepicker-widget modal hide fade in" data-backdrop="'+(this.modalBackdrop?"true":"false")+'"><div class="modal-header"><a href="#" class="close" data-dismiss="modal">&times;</a><h3>Pick a Time</h3></div><div class="modal-content">'+
a+'</div><div class="modal-footer"><a href="#" class="btn btn-primary" data-dismiss="modal">OK</a></div></div>';break;case "dropdown":d='<div class="bootstrap-timepicker-widget dropdown-menu">'+a+"</div>"}return d},getTime:function(){return""===this.hour?"":this.hour+":"+(1===this.minute.toString().length?"0"+this.minute:this.minute)+(this.showSeconds?":"+(1===this.second.toString().length?"0"+this.second:this.second):"")+(this.showMeridian?" "+this.meridian:"")},hideWidget:function(){!1!==this.isOpen&&
(this.$element.trigger({type:"hide.timepicker",time:{value:this.getTime(),hours:this.hour,minutes:this.minute,seconds:this.second,meridian:this.meridian}}),"modal"===this.template&&this.$widget.modal?this.$widget.modal("hide"):this.$widget.removeClass("open"),c(d).off("mousedown.timepicker, touchend.timepicker",this.handleDocumentClick),this.isOpen=!1,this.$widget.detach())},highlightUnit:function(){this.position=this.getCursorPosition();0<=this.position&&2>=this.position?this.highlightHour():3<=
...
this.minuteStep-this.minute%this.minuteStep;59<a?(this.incrementHour(),this.minute=a-60):this.minute=a},incrementSecond:function(){var a=this.second+this.secondStep-this.second%this.secondStep;59<a?(this.incrementMinute(!0),this.second=a-60):this.second=a},mousewheel:function(a){if(!this.disableMousewheel){a.preventDefault();a.stopPropagation();var b=a.originalEvent.wheelDelta||-a.originalEvent.detail,h=null;"mousewheel"===a.type?h=-1*a.originalEvent.wheelDelta:"DOMMouseScroll"===a.type&&(h=40*a.originalEvent.detail);
h&&(a.preventDefault(),c(this).scrollTop(h+c(this).scrollTop()));switch(this.highlightedUnit){case "minute":0<b?this.incrementMinute():this.decrementMinute();this.highlightMinute();break;case "second":0<b?this.incrementSecond():this.decrementSecond();this.highlightSecond();break;case "meridian":this.toggleMeridian();this.highlightMeridian();break;default:0<b?this.incrementHour():this.decrementHour(),this.highlightHour()}return!1}},changeToNearestStep:function(a,b){return 0===a%b?a:Math.round(a%b/
b)?(a+(b-a%b))%60:a-a%b},place:function(){if(!this.isInline){var a=this.$widget.outerWidth(),b=this.$widget.outerHeight(),h=c(e).width(),g=c(e).height(),d=c(e).scrollTop(),f=parseInt(this.$element.parents().filter(function(){return"auto"!==c(this).css("z-index")}).first().css("z-index"),10)+10,k=this.component?this.component.parent().offset():this.$element.offset(),n=this.component?this.component.outerHeight(!0):this.$element.outerHeight(!1),q=this.component?this.component.outerWidth(!0):this.$element.outerWidth(!1),
l=k.left,m=k.top;this.$widget.removeClass("timepicker-orient-top timepicker-orient-bottom timepicker-orient-right timepicker-orient-left");"auto"!==this.orientation.x?(this.$widget.addClass("timepicker-orient-"+this.orientation.x),"right"===this.orientation.x&&(l-=a-q)):(this.$widget.addClass("timepicker-orient-left"),0>k.left?l-=k.left-10:k.left+a>h&&(l=h-a-10));a=this.orientation.y;"auto"===a&&(a=-d+k.top-b,g=d+g-(k.top+n+b),a=Math.max(a,g)===g?"top":"bottom");this.$widget.addClass("timepicker-orient-"+
a);m="top"===a?m+n:m-(b+parseInt(this.$widget.css("padding-top"),10));this.$widget.css({top:m,left:l,zIndex:f})}},remove:function(){c("document").off(".timepicker");this.$widget&&this.$widget.remove();delete this.$element.data().timepicker},setDefaultTime:function(a){if(this.$element.val())this.updateFromElementVal();else if("current"===a){a=new Date;var b=a.getHours(),c=a.getMinutes(),g=a.getSeconds(),d="AM";0!==g&&(g=Math.ceil(a.getSeconds()/this.secondStep)*this.secondStep,60===g&&(c+=1,g=0));
0!==c&&(c=Math.ceil(a.getMinutes()/this.minuteStep)*this.minuteStep,60===c&&(b+=1,c=0));this.showMeridian&&(0===b?b=12:12<=b?(12<b&&(b-=12),d="PM"):d="AM");this.hour=b;this.minute=c;this.second=g;this.meridian=d;this.update()}else!1===a?(this.second=this.minute=this.hour=0,this.meridian="AM"):this.setTime(a)},setTime:function(a,c){if(a){if("object"===typeof a&&a.getMonth){var b=a.getHours();var d=a.getMinutes();a=a.getSeconds();if(this.showMeridian){var e="AM";12<b&&(e="PM",b%=12);12===b&&(e="PM")}}else{var f=
(/a/i.test(a)?1:0)+(/p/i.test(a)?2:0);if(2<f){this.clear();return}a=a.replace(/[^0-9:]/g,"").split(":");b=a[0]?a[0].toString():a.toString();if(this.explicitMode&&2<b.length&&0!==b.length%2){this.clear();return}d=a[1]?a[1].toString():"";a=a[2]?a[2].toString():"";4<b.length&&(a=b.slice(-2),b=b.slice(0,-2));2<b.length&&(d=b.slice(-2),b=b.slice(0,-2));2<d.length&&(a=d.slice(-2),d=d.slice(0,-2));b=parseInt(b,10);d=parseInt(d,10);a=parseInt(a,10);isNaN(b)&&(b=0);isNaN(d)&&(d=0);isNaN(a)&&(a=0);59<a&&(a=
59);59<d&&(d=59);b>=this.maxHours&&(b=this.maxHours-1);if(this.showMeridian)12<b&&(f=2,b-=12),f||(f=1),0===b&&(b=12),e=1===f?"AM":"PM";else if(12>b&&2===f)b+=12;else if(b>=this.maxHours)b=this.maxHours-1;else if(0>b||12===b&&1===f)b=0}this.hour=b;this.snapToStep?(this.minute=this.changeToNearestStep(d,this.minuteStep),this.second=this.changeToNearestStep(a,this.secondStep)):(this.minute=d,this.second=a);this.meridian=e;this.update(c)}else this.clear()},showWidget:function(){if(!this.isOpen&&!this.$element.is(":disabled")){this.$widget.appendTo(this.appendWidgetTo);
c(d).on("mousedown.timepicker, touchend.timepicker",{scope:this},this.handleDocumentClick);this.$element.trigger({type:"show.timepicker",time:{value:this.getTime(),hours:this.hour,minutes:this.minute,seconds:this.second,meridian:this.meridian}});this.place();this.disableFocus&&this.$element.blur();""===this.hour&&(this.defaultTime?this.setDefaultTime(this.defaultTime):this.setTime("0:0:0"));if("modal"===this.template&&this.$widget.modal)this.$widget.modal("show").on("hidden",c.proxy(this.hideWidget,
this));else!1===this.isOpen&&this.$widget.addClass("open");this.isOpen=!0}},toggleMeridian:function(){this.meridian="AM"===this.meridian?"PM":"AM"},update:function(a){this.updateElement();a||this.updateWidget();this.$element.trigger({type:"changeTime.timepicker",time:{value:this.getTime(),hours:this.hour,minutes:this.minute,seconds:this.second,meridian:this.meridian}})},updateElement:function(){this.$element.val(this.getTime()).change()},updateFromElementVal:function(){this.setTime(this.$element.val())},
...
c(this),e=d.data("timepicker"),p="object"===typeof a&&a;e||d.data("timepicker",e=new f(this,c.extend({},c.fn.timepicker.defaults,p,c(this).data())));"string"===typeof a&&e[a].apply(e,b)})};c.fn.timepicker.defaults={defaultTime:"current",disableFocus:!1,disableMousewheel:!1,isOpen:!1,minuteStep:15,modalBackdrop:!1,orientation:{x:"auto",y:"auto"},secondStep:15,snapToStep:!1,showSeconds:!1,showInputs:!0,showMeridian:!0,template:"dropdown",appendWidgetTo:"body",showWidgetOnAddonClick:!0,icons:{up:"glyphicon glyphicon-chevron-up",
down:"glyphicon glyphicon-chevron-down"},maxHours:24,explicitMode:!1};c.fn.timepicker.Constructor=f;c(d).on("focus.timepicker.data-api click.timepicker.data-api",'[data-provide="timepicker"]',function(a){var b=c(this);b.data("timepicker")||(a.preventDefault(),b.timepicker())})})(jQuery,window,document);
