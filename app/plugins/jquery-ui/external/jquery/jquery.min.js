jquery.js:751: WARNING - [JSC_USELESS_CODE] Suspicious code. The result of the 'getprop' operator is not being used.
	arr[ preferredDoc.childNodes.length ].nodeType;
	^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

jquery.js:1683: WARNING - [JSC_SUSPICIOUS_LEFT_OPERAND_OF_LOGICAL_OPERATOR] Left operand of && operator is always truthy.
				(pattern = new RegExp( "(^|" + whitespace + ")" + className + "(" + whitespace + "|$)" )) &&
				^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

jquery.js:1986: WARNING - [JSC_USELESS_CODE] Suspicious code. This code lacks side-effects. Is there a bug?
			if ( elem.parentNode ) {
			^^^^^^^^^^^^^^^^^^^^^^^^

jquery.js:1987: WARNING - [JSC_USELESS_CODE] Suspicious code. The result of the 'getprop' operator is not being used.
				elem.parentNode.selectedIndex;
				^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

jquery.js:8338: WARNING - [JSC_USELESS_CODE] Suspicious code. The result of the 'getprop' operator is not being used.
							option.scrollHeight;
							^^^^^^^^^^^^^^^^^^^

jquery.js:8755: WARNING - [JSC_USELESS_CODE] Suspicious code. This code lacks side-effects. Is there a bug?
			if ( parent ) {
			^^^^^^^^^^^^^^^

jquery.js:8756: WARNING - [JSC_USELESS_CODE] Suspicious code. The result of the 'getprop' operator is not being used.
				parent.selectedIndex;
				^^^^^^^^^^^^^^^^^^^^

jquery.js:8759: WARNING - [JSC_USELESS_CODE] Suspicious code. This code lacks side-effects. Is there a bug?
				if ( parent.parentNode ) {
				^^^^^^^^^^^^^^^^^^^^^^^^^^

jquery.js:8760: WARNING - [JSC_USELESS_CODE] Suspicious code. The result of the 'getprop' operator is not being used.
					parent.parentNode.selectedIndex;
					^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

jquery.js:8767: WARNING - [JSC_USELESS_CODE] Suspicious code. This code lacks side-effects. Is there a bug?
			if ( parent ) {
			^^^^^^^^^^^^^^^

jquery.js:8768: WARNING - [JSC_USELESS_CODE] Suspicious code. The result of the 'getprop' operator is not being used.
				parent.selectedIndex;
				^^^^^^^^^^^^^^^^^^^^

jquery.js:8770: WARNING - [JSC_USELESS_CODE] Suspicious code. This code lacks side-effects. Is there a bug?
				if ( parent.parentNode ) {
				^^^^^^^^^^^^^^^^^^^^^^^^^^

jquery.js:8771: WARNING - [JSC_USELESS_CODE] Suspicious code. The result of the 'getprop' operator is not being used.
					parent.parentNode.selectedIndex;
					^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
/*
 ...
 Date: 2015-10-17
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(m,v,A){m instanceof String&&(m=String(m));for(var E=m.length,S=0;S<E;S++){var ua=m[S];if(v.call(A,ua,S,m))return{i:S,v:ua}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(m,v,A){m!=Array.prototype&&m!=Object.prototype&&(m[v]=A.value)};$jscomp.getGlobal=function(m){m=["object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global,m];for(var v=0;v<m.length;++v){var A=m[v];if(A&&A.Math==Math)return A}return globalThis};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(m,v,A,E){if(v){A=$jscomp.global;m=m.split(".");for(E=0;E<m.length-1;E++){var S=m[E];S in A||(A[S]={});A=A[S]}m=m[m.length-1];E=A[m];v=v(E);v!=E&&null!=v&&$jscomp.defineProperty(A,m,{configurable:!0,writable:!0,value:v})}};$jscomp.polyfill("Array.prototype.find",function(m){return m?m:function(m,A){return $jscomp.findInternal(this,m,A).v}},"es6","es3");
(function(m,v){"object"===typeof module&&"object"===typeof module.exports?module.exports=m.document?v(m,!0):function(m){if(!m.document)throw Error("jQuery requires a window with a document");return v(m)}:v(m)})("undefined"!==typeof window?window:this,function(m,v){function A(a){var b=!!a&&"length"in a&&a.length,d=c.type(a);return"function"===d||c.isWindow(a)?!1:"array"===d||0===b||"number"===typeof b&&0<b&&b-1 in a}function E(a,b,d){if(c.isFunction(b))return c.grep(a,function(a,c){return!!b.call(a,
...
f);var g=f.events;if(g)for(d in delete a.handle,a.events={},g)for(f=0,e=g[d].length;f<e;f++)c.event.add(b,d,g[d][f]);a.data&&(a.data=c.extend({},a.data))}}function da(a,b,d,e){b=vb.apply([],b);var f,g=0,h=a.length,l=h-1,k=b[0],n=c.isFunction(k);if(n||1<h&&"string"===typeof k&&!q.checkClone&&jc.test(k))return a.each(function(c){var f=a.eq(c);n&&(b[0]=k.call(this,c,f.html()));da(f,b,d,e)});if(h){var r=mb(b,a[0].ownerDocument,!1,a,e);var t=r.firstChild;1===r.childNodes.length&&(r=t);if(t||e){var m=c.map(C(r,
"script"),sb);for(f=m.length;g<h;g++)t=r,g!==l&&(t=c.clone(t,!0,!0),f&&c.merge(m,C(t,"script"))),d.call(a[g],t,g);if(f)for(r=m[m.length-1].ownerDocument,c.map(m,tb),g=0;g<f;g++)t=m[g],pb.test(t.type||"")&&!c._data(t,"globalEval")&&c.contains(r,t)&&(t.src?c._evalUrl&&c._evalUrl(t.src):c.globalEval((t.text||t.textContent||t.innerHTML||"").replace(kc,"")));r=t=null}}return a}function wb(a,b,d){for(var e=b?c.filter(b,a):a,f=0;null!=(b=e[f]);f++)d||1!==b.nodeType||c.cleanData(C(b)),b.parentNode&&(d&&c.contains(b.ownerDocument,
b)&&Ka(C(b,"script")),b.parentNode.removeChild(b));return a}function xb(a,b){a=c(b.createElement(a)).appendTo(b.body);b=c.css(a[0],"display");a.detach();return b}function pa(a){var b=p,d=yb[a];d||(d=xb(a,b),"none"!==d&&d||(va=(va||c("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement),b=(va[0].contentWindow||va[0].contentDocument).document,b.write(),b.close(),d=xb(a,b),va.detach()),yb[a]=d);return d}function Pa(a,b){return{get:function(){if(a())delete this.get;else return(this.get=
...
"constructor")&&!ja.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(d){return!1}if(!q.ownFirst)for(b in a)return ja.call(a,b);for(b in a);return void 0===b||ja.call(a,b)},type:function(a){return null==a?a+"":"object"===typeof a||"function"===typeof a?Ba[pc.call(a)]||"object":typeof a},globalEval:function(a){a&&c.trim(a)&&(m.execScript||function(a){m.eval.call(m,a)})(a)},camelCase:function(a){return a.replace(rc,"ms-").replace(sc,tc)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===
b.toLowerCase()},each:function(a,b){var c,e=0;if(A(a))for(c=a.length;e<c&&!1!==b.call(a[e],e,a[e]);e++);else for(e in a)if(!1===b.call(a[e],e,a[e]))break;return a},trim:function(a){return null==a?"":(a+"").replace(qc,"")},makeArray:function(a,b){b=b||[];null!=a&&(A(Object(a))?c.merge(b,"string"===typeof a?[a]:a):Ua.call(b,a));return b},inArray:function(a,b,c){if(b){if(Mb)return Mb.call(b,a,c);var d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;c<d;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,
b){for(var c=+b.length,e=0,f=a.length;e<c;)a[f++]=b[e++];if(c!==c)for(;void 0!==b[e];)a[f++]=b[e++];a.length=f;return a},grep:function(a,b,c){for(var d=[],f=0,g=a.length,h=!c;f<g;f++)c=!b(a[f],f),c!==h&&d.push(a[f]);return d},map:function(a,b,c){var d,f=0,g=[];if(A(a))for(d=a.length;f<d;f++){var h=b(a[f],f,c);null!=h&&g.push(h)}else for(f in a)h=b(a[f],f,c),null!=h&&g.push(h);return vb.apply([],g)},guid:1,proxy:function(a,b){if("string"===typeof b){var d=a[b];b=a;a=d}if(c.isFunction(a)){var e=ea.call(arguments,
2);d=function(){return a.apply(b||this,e.concat(ea.call(arguments)))};d.guid=a.guid=a.guid||c.guid++;return d}},now:function(){return+new Date},support:q});"function"===typeof Symbol&&(c.fn[Symbol.iterator]=Y[Symbol.iterator]);c.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(a,b){Ba["[object "+b+"]"]=b.toLowerCase()});var ba=function(a){function b(a,b,c,d){var e,f,g,u,h=b&&b.ownerDocument,y=b?b.nodeType:9;c=c||[];if("string"!==typeof a||!a||1!==y&&
9!==y&&11!==y)return c;if(!d&&((b?b.ownerDocument||b:B)!==w&&xa(b),b=b||w,Z)){if(11!==y&&(u=va.exec(a)))if(e=u[1])if(9===y)if(f=b.getElementById(e)){if(f.id===e)return c.push(f),c}else return c;else{if(h&&(f=h.getElementById(e))&&E(b,f)&&f.id===e)return c.push(f),c}else{if(u[2])return H.apply(c,b.getElementsByTagName(a)),c;if((e=u[3])&&I.getElementsByClassName&&b.getElementsByClassName)return H.apply(c,b.getElementsByClassName(e)),c}if(!(!I.qsa||N[a+" "]||P&&P.test(a))){if(1!==y){h=b;var l=a}else if("object"!==
b.nodeName.toLowerCase()){(g=b.getAttribute("id"))?g=g.replace(za,"\\$&"):b.setAttribute("id",g=z);u=ia(a);e=u.length;for(f=ja.test(g)?"#"+g:"[id='"+g+"']";e--;)u[e]=f+" "+q(u[e]);l=u.join(",");h=fa.test(a)&&r(b.parentNode)||b}if(l)try{return H.apply(c,h.querySelectorAll(l)),c}catch(ad){}finally{g===z&&b.removeAttribute("id")}}}return Ba(a.replace(V,"$1"),b,c,d)}function c(){function a(c,d){b.push(c+" ")>D.cacheLength&&delete a[b.shift()];return a[c+" "]=d}var b=[];return a}function e(a){a[z]=!0;
...
b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}}function n(a){return e(function(b){b=+b;return e(function(c,d){for(var e,f=a([],c.length,b),g=f.length;g--;)c[e=f[g]]&&(c[e]=!(d[e]=c[e]))})})}function r(a){return a&&"undefined"!==typeof a.getElementsByTagName&&a}function m(){}function q(a){for(var b=0,c=a.length,d="";b<c;b++)d+=a[b].value;return d}function p(a,b,c){var d=b.dir,e=c&&"parentNode"===d,f=S++;return b.first?function(b,c,f){for(;b=b[d];)if(1===b.nodeType||e)return a(b,
c,f)}:function(b,c,g){var h,u=[ka,f];if(g)for(;b=b[d];){if((1===b.nodeType||e)&&a(b,c,g))return!0}else for(;b=b[d];)if(1===b.nodeType||e){var y=b[z]||(b[z]={});y=y[b.uniqueID]||(y[b.uniqueID]={});if((h=y[d])&&h[0]===ka&&h[1]===f)return u[2]=h[2];y[d]=u;if(u[2]=a(b,c,g))return!0}}}function K(a){return 1<a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function A(a,b,c,d,e){for(var f,g=[],h=0,u=a.length,y=null!=b;h<u;h++)if(f=a[h])if(!c||c(f,d,e))g.push(f),y&&
b.push(h);return g}function v(a,c,d,f,g,h){f&&!f[z]&&(f=v(f));g&&!g[z]&&(g=v(g,h));return e(function(e,h,u,y){var l,k=[],n=[],W=h.length,M;if(!(M=e)){M=c||"*";for(var m=u.nodeType?[u]:u,r=[],t=0,q=m.length;t<q;t++)b(M,m[t],r);M=r}M=!a||!e&&c?M:A(M,k,a,u,y);m=d?g||(e?a:W||f)?[]:h:M;d&&d(M,m,u,y);if(f){var p=A(m,n);f(p,[],u,y);for(u=p.length;u--;)if(l=p[u])m[n[u]]=!(M[n[u]]=l)}if(e){if(g||a){if(g){p=[];for(u=m.length;u--;)(l=m[u])&&p.push(M[u]=l);g(null,m=[],p,y)}for(u=m.length;u--;)(l=m[u])&&-1<(p=
g?R(e,l):k[u])&&(e[p]=!(h[p]=l))}}else m=A(m===h?m.splice(W,m.length):m),g?g(null,h,m,y):H.apply(h,m)})}function C(a){var b,c,d=a.length,e=D.relative[a[0].type];var f=e||D.relative[" "];for(var g=e?1:0,h=p(function(a){return a===b},f,!0),u=p(function(a){return-1<R(b,a)},f,!0),l=[function(a,c,d){a=!e&&(d||c!==O)||((b=c).nodeType?h(a,c,d):u(a,c,d));b=null;return a}];g<d;g++)if(f=D.relative[a[g].type])l=[p(K(l),f)];else{f=D.filter[a[g].type].apply(null,a[g].matches);if(f[z]){for(c=++g;c<d&&!D.relative[a[c].type];c++);
return v(1<g&&K(l),1<g&&q(a.slice(0,g-1).concat({value:" "===a[g-2].type?"*":""})).replace(V,"$1"),f,g<c&&C(a.slice(g,c)),c<d&&C(a=a.slice(c)),c<d&&q(a))}l.push(f)}return K(l)}function G(a,c){var d=0<c.length,f=0<a.length,g=function(e,g,h,u,l){var y,k,n=0,W="0",M=e&&[],m=[],r=O,t=e||f&&D.find.TAG("*",l),p=ka+=null==r?1:Math.random()||.1,q=t.length;for(l&&(O=g===w||g||l);W!==q&&null!=(y=t[W]);W++){if(f&&y){var Va=0;g||y.ownerDocument===w||(xa(y),h=!Z);for(;k=a[Va++];)if(k(y,g||w,h)){u.push(y);break}l&&
(ka=p)}d&&((y=!k&&y)&&n--,e&&M.push(y))}n+=W;if(d&&W!==n){for(Va=0;k=c[Va++];)k(M,m,g,h);if(e){if(0<n)for(;W--;)M[W]||m[W]||(m[W]=ca.call(u));m=A(m)}H.apply(u,m);l&&!e&&0<m.length&&1<n+c.length&&b.uniqueSort(u)}l&&(ka=p,O=r);return M};return d?e(g):g}var x,O,L,Q,w,aa,Z,P,ya,Ca,E,z="sizzle"+1*new Date,B=a.document,ka=0,S=0,J=c(),U=c(),N=c(),T=function(a,b){a===b&&(Q=!0);return 0},Y={}.hasOwnProperty,F=[],ca=F.pop,ea=F.push,H=F.push,da=F.slice,R=function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]===
...
va=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,fa=/[+~]/,za=/'|\\/g,la=/\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig,ma=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)},ua=function(){xa()};try{H.apply(F=da.call(B.childNodes),B.childNodes),F[B.childNodes.length].nodeType}catch(u){H={apply:F.length?function(a,b){ea.apply(a,da.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}var I=b.support={};
var Aa=b.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};var xa=b.setDocument=function(a){var b;a=a?a.ownerDocument||a:B;if(a===w||9!==a.nodeType||!a.documentElement)return w;w=a;aa=w.documentElement;Z=!Aa(w);(b=w.defaultView)&&b.top!==b&&(b.addEventListener?b.addEventListener("unload",ua,!1):b.attachEvent&&b.attachEvent("onunload",ua));I.attributes=f(function(a){a.className="i";return!a.getAttribute("className")});I.getElementsByTagName=f(function(a){a.appendChild(w.createComment(""));
return!a.getElementsByTagName("*").length});I.getElementsByClassName=X.test(w.getElementsByClassName);I.getById=f(function(a){aa.appendChild(a).id=z;return!w.getElementsByName||!w.getElementsByName(z).length});I.getById?(D.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&Z)return(a=b.getElementById(a))?[a]:[]},D.filter.ID=function(a){var b=a.replace(la,ma);return function(a){return a.getAttribute("id")===b}}):(delete D.find.ID,D.filter.ID=function(a){var b=a.replace(la,ma);return function(a){return(a=
"undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id"))&&a.value===b}});D.find.TAG=I.getElementsByTagName?function(a,b){if("undefined"!==typeof b.getElementsByTagName)return b.getElementsByTagName(a);if(I.qsa)return b.querySelectorAll(a)}:function(a,b){var c=[],d=0;b=b.getElementsByTagName(a);if("*"===a){for(;a=b[d++];)1===a.nodeType&&c.push(a);return c}return b};D.find.CLASS=I.getElementsByClassName&&function(a,b){if("undefined"!==typeof b.getElementsByClassName&&Z)return b.getElementsByClassName(a)};
ya=[];P=[];if(I.qsa=X.test(w.querySelectorAll))f(function(a){aa.appendChild(a).innerHTML="<a id='"+z+"'></a><select id='"+z+"-\r\\' msallowcapture=''><option selected=''></option></select>";a.querySelectorAll("[msallowcapture^='']").length&&P.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||P.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");a.querySelectorAll("[id~="+
z+"-]").length||P.push("~=");a.querySelectorAll(":checked").length||P.push(":checked");a.querySelectorAll("a#"+z+"+*").length||P.push(".#.+[+~]")}),f(function(a){var b=w.createElement("input");b.setAttribute("type","hidden");a.appendChild(b).setAttribute("name","D");a.querySelectorAll("[name=d]").length&&P.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");a.querySelectorAll(":enabled").length||P.push(":enabled",":disabled");a.querySelectorAll("*,:x");P.push(",.*:")});(I.matchesSelector=X.test(Ca=aa.matches||
...
if(c)return c;c=(a.ownerDocument||a)===(b.ownerDocument||b)?a.compareDocumentPosition(b):1;return c&1||!I.sortDetached&&b.compareDocumentPosition(a)===c?a===w||a.ownerDocument===B&&E(B,a)?-1:b===w||b.ownerDocument===B&&E(B,b)?1:L?R(L,a)-R(L,b):0:c&4?-1:1}:function(a,b){if(a===b)return Q=!0,0;var c=0,d=a.parentNode,e=b.parentNode,f=[a],g=[b];if(!d||!e)return a===w?-1:b===w?1:d?-1:e?1:L?R(L,a)-R(L,b):0;if(d===e)return h(a,b);for(;a=a.parentNode;)f.unshift(a);for(a=b;a=a.parentNode;)g.unshift(a);for(;f[c]===
g[c];)c++;return c?h(f[c],g[c]):f[c]===B?-1:g[c]===B?1:0};return w};b.matches=function(a,c){return b(a,null,null,c)};b.matchesSelector=function(a,c){(a.ownerDocument||a)!==w&&xa(a);c=c.replace(qa,"='$1']");if(!(!I.matchesSelector||!Z||N[c+" "]||ya&&ya.test(c)||P&&P.test(c)))try{var d=Ca.call(a,c);if(d||I.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(M){}return 0<b(c,w,null,[a]).length};b.contains=function(a,b){(a.ownerDocument||a)!==w&&xa(a);return E(a,b)};b.attr=function(a,
b){(a.ownerDocument||a)!==w&&xa(a);var c=D.attrHandle[b.toLowerCase()];c=c&&Y.call(D.attrHandle,b.toLowerCase())?c(a,b,!Z):void 0;return void 0!==c?c:I.attributes||!Z?a.getAttribute(b):(c=a.getAttributeNode(b))&&c.specified?c.value:null};b.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};b.uniqueSort=function(a){var b,c=[],d=0,e=0;Q=!I.detectDuplicates;L=!I.sortStable&&a.slice(0);a.sort(T);if(Q){for(;b=a[e++];)b===a[e]&&(d=c.push(e));for(;d--;)a.splice(c[d],1)}L=null;return a};
...
b.attr(e,a);if(null==e)return"!="===c;if(!c)return!0;e+="";return"="===c?e===d:"!="===c?e!==d:"^="===c?d&&0===e.indexOf(d):"*="===c?d&&-1<e.indexOf(d):"$="===c?d&&e.slice(-d.length)===d:"~="===c?-1<(" "+e.replace(ha," ")+" ").indexOf(d):"|="===c?e===d||e.slice(0,d.length+1)===d+"-":!1}},CHILD:function(a,b,c,d,e){var f="nth"!==a.slice(0,3),g="last"!==a.slice(-4),h="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,l){var k,n;c=f!==g?"nextSibling":"previousSibling";var u=
b.parentNode,m=h&&b.nodeName.toLowerCase();l=!l&&!h;var r=!1;if(u){if(f){for(;c;){for(k=b;k=k[c];)if(h?k.nodeName.toLowerCase()===m:1===k.nodeType)return!1;var y=c="only"===a&&!y&&"nextSibling"}return!0}y=[g?u.firstChild:u.lastChild];if(g&&l){k=u;var t=k[z]||(k[z]={});t=t[k.uniqueID]||(t[k.uniqueID]={});r=t[a]||[];r=(n=r[0]===ka&&r[1])&&r[2];for(k=n&&u.childNodes[n];k=++n&&k&&k[c]||(r=n=0)||y.pop();)if(1===k.nodeType&&++r&&k===b){t[a]=[ka,n,r];break}}else if(l&&(k=b,t=k[z]||(k[z]={}),t=t[k.uniqueID]||
(t[k.uniqueID]={}),r=t[a]||[],r=n=r[0]===ka&&r[1]),!1===r)for(;(k=++n&&k&&k[c]||(r=n=0)||y.pop())&&((h?k.nodeName.toLowerCase()!==m:1!==k.nodeType)||!++r||(l&&(t=k[z]||(k[z]={}),t=t[k.uniqueID]||(t[k.uniqueID]={}),t[a]=[ka,r]),k!==b)););r-=e;return r===d||0===r%d&&0<=r/d}}},PSEUDO:function(a,c){var d=D.pseudos[a]||D.setFilters[a.toLowerCase()]||b.error("unsupported pseudo: "+a);if(d[z])return d(c);if(1<d.length){var f=[a,a,"",c];return D.setFilters.hasOwnProperty(a.toLowerCase())?e(function(a,b){for(var e,
...
0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:n(function(a,b,c){for(c=0>c?c+b:c;++c<b;)a.push(c);return a})}};D.pseudos.nth=D.pseudos.eq;for(x in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})D.pseudos[x]=l(x);for(x in{submit:!0,reset:!0})D.pseudos[x]=k(x);m.prototype=D.filters=D.pseudos;D.setFilters=new m;var ia=b.tokenize=function(a,c){var d,e,f,g,h;if(g=U[a+" "])return c?0:g.slice(0);g=a;var l=[];for(h=D.preFilter;g;){if(!k||(d=na.exec(g)))d&&(g=g.slice(d[0].length)||g),l.push(e=[]);var k=!1;
if(d=oa.exec(g))k=d.shift(),e.push({value:k,type:d[0].replace(V," ")}),g=g.slice(k.length);for(f in D.filter)!(d=ba[f].exec(g))||h[f]&&!(d=h[f](d))||(k=d.shift(),e.push({value:k,type:f,matches:d}),g=g.slice(k.length));if(!k)break}return c?g.length:g?b.error(a):U(a,l).slice(0)};var wa=b.compile=function(a,b){var c,d=[],e=[],f=N[a+" "];if(!f){b||(b=ia(a));for(c=b.length;c--;)f=C(b[c]),f[z]?d.push(f):e.push(f);f=N(a,G(e,d));f.selector=a}return f};var Ba=b.select=function(a,b,c,d){var e,f,g,h="function"===
typeof a&&a,l=!d&&ia(a=h.selector||a);c=c||[];if(1===l.length){var k=l[0]=l[0].slice(0);if(2<k.length&&"ID"===(f=k[0]).type&&I.getById&&9===b.nodeType&&Z&&D.relative[k[1].type]){b=(D.find.ID(f.matches[0].replace(la,ma),b)||[])[0];if(!b)return c;h&&(b=b.parentNode);a=a.slice(k.shift().value.length)}for(e=ba.needsContext.test(a)?0:k.length;e--;){f=k[e];if(D.relative[g=f.type])break;if(g=D.find[g])if(d=g(f.matches[0].replace(la,ma),fa.test(k[0].type)&&r(b.parentNode)||b)){k.splice(e,1);a=d.length&&q(k);
if(!a)return H.apply(c,d),c;break}}}(h||wa(a,l))(d,b,!Z,c,!b||fa.test(a)&&r(b.parentNode)||b);return c};I.sortStable=z.split("").sort(T).join("")===z;I.detectDuplicates=!!Q;xa();I.sortDetached=f(function(a){return a.compareDocumentPosition(w.createElement("div"))&1});f(function(a){a.innerHTML="<a href='#'></a>";return"#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,b,c){if(!c)return a.getAttribute(b,"type"===b.toLowerCase()?1:2)});I.attributes&&f(function(a){a.innerHTML=
...
a||[],!1))},not:function(a){return this.pushStack(E(this,a||[],!0))},is:function(a){return!!E(this,"string"===typeof a&&Ob.test(a)?c(a):a||[],!1).length}});var vc=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(c.fn.init=function(a,b,d){if(!a)return this;d=d||Qb;if("string"===typeof a){var e="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:vc.exec(a);if(!e||!e[1]&&b)return!b||b.jquery?(b||d).find(a):this.constructor(b).find(a);if(e[1]){if(b=b instanceof c?b[0]:b,c.merge(this,c.parseHTML(e[1],
...
return c.makeArray(a,this)}).prototype=c.fn;var Qb=c(p);var wc=/^(?:parents|prev(?:Until|All))/,xc={children:!0,contents:!0,next:!0,prev:!0};c.fn.extend({has:function(a){var b,d=c(a,this),e=d.length;return this.filter(function(){for(b=0;b<e;b++)if(c.contains(this,d[b]))return!0})},closest:function(a,b){for(var d,e=0,f=this.length,g=[],h=Ob.test(a)||"string"!==typeof a?c(a,b||this.context):0;e<f;e++)for(d=this[e];d&&d!==b;d=d.parentNode)if(11>d.nodeType&&(h?-1<h.index(d):1===d.nodeType&&c.find.matchesSelector(d,
...
"iframe")?a.contentDocument||a.contentWindow.document:c.merge([],a.childNodes)}},function(a,b){c.fn[a]=function(d,e){var f=c.map(this,b,d);"Until"!==a.slice(-5)&&(e=d);e&&"string"===typeof e&&(f=c.filter(e,f));1<this.length&&(xc[a]||(f=c.uniqueSort(f)),wc.test(a)&&(f=f.reverse()));return this.pushStack(f)}});var T=/\S+/g;c.Callbacks=function(a){a="string"===typeof a?ua(a):c.extend({},a);var b,d,e,f,g=[],h=[],l=-1,k=function(){f=a.once;for(e=b=!0;h.length;l=-1)for(d=h.shift();++l<g.length;)!1===g[l].apply(d[0],
...
J.optgroup=J.option;J.tbody=J.tfoot=J.colgroup=J.caption=J.thead;J.th=J.td;var hc=/<|&#?\w+;/,ob=/<tbody/i;(function(){var a,b=p.createElement("div");for(a in{submit:!0,change:!0,focusin:!0}){var c="on"+a;(q[a]=c in m)||(b.setAttribute(c,"t"),q[a]=!1===b.attributes[c].expando)}})();var Xa=/^(?:input|select|textarea)$/i,zc=/^key/,Ac=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,Rb=/^(?:focusinfocus|focusoutblur)$/,Sb=/^([^.]*)(?:\.(.+)|)/;c.event={global:{},add:function(a,b,d,e,f){var g,h,l,k,n;
if(h=c._data(a)){if(d.handler){var m=d;d=m.handler;f=m.selector}d.guid||(d.guid=c.guid++);(g=h.events)||(g=h.events={});(l=h.handle)||(l=h.handle=function(a){return"undefined"===typeof c||a&&c.event.triggered===a.type?void 0:c.event.dispatch.apply(l.elem,arguments)},l.elem=a);b=(b||"").match(T)||[""];for(h=b.length;h--;){var t=Sb.exec(b[h])||[];var p=k=t[1];var q=(t[2]||"").split(".").sort();p&&(t=c.event.special[p]||{},p=(f?t.delegateType:t.bindType)||p,t=c.event.special[p]||{},k=c.extend({type:p,
origType:k,data:e,handler:d,guid:d.guid,selector:f,needsContext:f&&c.expr.match.needsContext.test(f),namespace:q.join(".")},m),(n=g[p])||(n=g[p]=[],n.delegateCount=0,t.setup&&!1!==t.setup.call(a,e,q,l)||(a.addEventListener?a.addEventListener(p,l,!1):a.attachEvent&&a.attachEvent("on"+p,l))),t.add&&(t.add.call(a,k),k.handler.guid||(k.handler.guid=d.guid)),f?n.splice(n.delegateCount++,0,k):n.push(k),c.event.global[p]=!0)}a=null}},remove:function(a,b,d,e,f){var g,h,l,k,n,m=c.hasData(a)&&c._data(a);if(m&&
(k=m.events)){b=(b||"").match(T)||[""];for(l=b.length;l--;){var p=Sb.exec(b[l])||[];var q=n=p[1];var A=(p[2]||"").split(".").sort();if(q){var K=c.event.special[q]||{};q=(e?K.delegateType:K.bindType)||q;var v=k[q]||[];p=p[2]&&new RegExp("(^|\\.)"+A.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=g=v.length;g--;){var C=v[g];!f&&n!==C.origType||d&&d.guid!==C.guid||p&&!p.test(C.namespace)||e&&e!==C.selector&&("**"!==e||!C.selector)||(v.splice(g,1),C.selector&&v.delegateCount--,K.remove&&K.remove.call(a,C))}h&&
!v.length&&(K.teardown&&!1!==K.teardown.call(a,A,m.handle)||c.removeEvent(a,q,m.handle),delete k[q])}else for(q in k)c.event.remove(a,q+b[l],d,e,!0)}c.isEmptyObject(k)&&(delete m.handle,c._removeData(a,"events"))}},trigger:function(a,b,d,e){var f,g,h=[d||p],l=ja.call(a,"type")?a.type:a;var k=ja.call(a,"namespace")?a.namespace.split("."):[];var n=f=d=d||p;if(3!==d.nodeType&&8!==d.nodeType&&!Rb.test(l+c.event.triggered)){-1<l.indexOf(".")&&(k=l.split("."),l=k.shift(),k.sort());var r=0>l.indexOf(":")&&
"on"+l;a=a[c.expando]?a:new c.Event(l,"object"===typeof a&&a);a.isTrigger=e?2:3;a.namespace=k.join(".");a.rnamespace=a.namespace?new RegExp("(^|\\.)"+k.join("\\.(?:.*\\.|)")+"(\\.|$)"):null;a.result=void 0;a.target||(a.target=d);b=null==b?[a]:c.makeArray(b,[a]);k=c.event.special[l]||{};if(e||!k.trigger||!1!==k.trigger.apply(d,b)){if(!e&&!k.noBubble&&!c.isWindow(d)){var q=k.delegateType||l;Rb.test(q+l)||(n=n.parentNode);for(;n;n=n.parentNode)h.push(n),f=n;f===(d.ownerDocument||p)&&h.push(f.defaultView||
f.parentWindow||m)}for(g=0;(n=h[g++])&&!a.isPropagationStopped();)a.type=1<g?q:k.bindType||l,(f=(c._data(n,"events")||{})[a.type]&&c._data(n,"handle"))&&f.apply(n,b),(f=r&&n[r])&&f.apply&&X(n)&&(a.result=f.apply(n,b),!1===a.result&&a.preventDefault());a.type=l;if(!(e||a.isDefaultPrevented()||k._default&&!1!==k._default.apply(h.pop(),b))&&X(d)&&r&&d[l]&&!c.isWindow(d)){(f=d[r])&&(d[r]=null);c.event.triggered=l;try{d[l]()}catch(Ma){}c.event.triggered=void 0;f&&(d[r]=f)}return a.result}}},dispatch:function(a){a=
...
if(d)return c.event.trigger(a,b,d,!0)}});var Bc=/ jQuery\d+="(?:null|\d+)"/g,Tb=/<(?:abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video)[\s/>]/i,Cc=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,Dc=/<script|<style|<link/i,jc=/checked\s*(?:[^=]|=\s*.checked.)/i,ic=/^true\/(.*)/,kc=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,Ya=lb(p).appendChild(p.createElement("div"));
c.extend({htmlPrefilter:function(a){return a.replace(Cc,"<$1></$2>")},clone:function(a,b,d){var e,f,g=c.contains(a.ownerDocument,a);if(q.html5Clone||c.isXMLDoc(a)||!Tb.test("<"+a.nodeName+">"))var h=a.cloneNode(!0);else Ya.innerHTML=a.outerHTML,Ya.removeChild(h=Ya.firstChild);if(!(q.noCloneEvent&&q.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||c.isXMLDoc(a))){var l=C(h);var k=C(a);for(f=0;null!=(e=k[f]);++f)if(l[f]){var n=void 0,m=e,p=l[f];if(1===p.nodeType){var v=p.nodeName.toLowerCase();if(!q.noCloneEvent&&
p[c.expando]){e=c._data(p);for(n in e.events)c.removeEvent(p,n,e.handle);p.removeAttribute(c.expando)}if("script"===v&&p.text!==m.text)sb(p).text=m.text,tb(p);else if("object"===v)p.parentNode&&(p.outerHTML=m.outerHTML),q.html5Clone&&m.innerHTML&&!c.trim(p.innerHTML)&&(p.innerHTML=m.innerHTML);else if("input"===v&&La.test(m.type))p.defaultChecked=p.checked=m.checked,p.value!==m.value&&(p.value=m.value);else if("option"===v)p.defaultSelected=p.selected=m.defaultSelected;else if("input"===v||"textarea"===
v)p.defaultValue=m.defaultValue}}}if(b)if(d)for(k=k||C(a),l=l||C(h),f=0;null!=(e=k[f]);f++)ub(e,l[f]);else ub(a,h);l=C(h,"script");0<l.length&&Ka(l,!g&&C(a,"script"));return h},cleanData:function(a,b){for(var d,e,f,g,h=0,l=c.expando,k=c.cache,n=q.attributes,m=c.event.special;null!=(d=a[h]);h++)if(b||X(d))if(g=(f=d[l])&&k[f]){if(g.events)for(e in g.events)m[e]?c.event.remove(d,e):c.removeEvent(d,e,g.handle);k[f]&&(delete k[f],n||"undefined"===typeof d.removeAttribute?d[l]=void 0:d.removeAttribute(l),
...
0)}return this},clone:function(a,b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return c.clone(this,a,b)})},html:function(a){return H(this,function(a){var b=this[0]||{},e=0,f=this.length;if(void 0===a)return 1===b.nodeType?b.innerHTML.replace(Bc,""):void 0;if(!("string"!==typeof a||Dc.test(a)||!q.htmlSerialize&&Tb.test(a)||!q.leadingWhitespace&&Na.test(a)||J[(nb.exec(a)||["",""])[1].toLowerCase()])){a=c.htmlPrefilter(a);try{for(;e<f;e++)b=this[e]||{},1===b.nodeType&&(c.cleanData(C(b,!1)),
...
{reliableHiddenOffsets:function(){null==b&&a();return f},boxSizingReliable:function(){null==b&&a();return e},pixelMarginRight:function(){null==b&&a();return d},pixelPosition:function(){null==b&&a();return b},reliableMarginRight:function(){null==b&&a();return g},reliableMarginLeft:function(){null==b&&a();return h}}))})();var Ec=/^(top|right|bottom|left)$/;if(m.getComputedStyle){var qa=function(a){var b=a.ownerDocument.defaultView;b&&b.opener||(b=m);return b.getComputedStyle(a)};var ha=function(a,b,
d){var e=a.style;var f=(d=d||qa(a))?d.getPropertyValue(b)||d[b]:void 0;""!==f&&void 0!==f||c.contains(a.ownerDocument,a)||(f=c.style(a,b));if(d&&!q.pixelMarginRight()&&ia.test(f)&&Ub.test(b)){a=e.width;b=e.minWidth;var g=e.maxWidth;e.minWidth=e.maxWidth=e.width=f;f=d.width;e.width=a;e.minWidth=b;e.maxWidth=g}return void 0===f?f:f+""}}else Vb.currentStyle&&(qa=function(a){return a.currentStyle},ha=function(a,b,c){var d,f,g=a.style;var h=(c=c||qa(a))?c[b]:void 0;null==h&&g&&g[b]&&(h=g[b]);if(ia.test(h)&&
!Ec.test(b)){c=g.left;if(f=(d=a.runtimeStyle)&&d.left)d.left=a.currentStyle.left;g.left="fontSize"===b?"1em":h;h=g.pixelLeft+"px";g.left=c;f&&(d.left=f)}return void 0===h?h:h+""||"auto"});var $a=/alpha\([^)]*\)/i,Fc=/opacity\s*=\s*([^)]*)/i,Gc=/^(none|table(?!-c[ea]).+)/,lc=new RegExp("^("+Wa+")(.*)$","i"),Hc={position:"absolute",visibility:"hidden",display:"block"},Wb={letterSpacing:"0",fontWeight:"400"},Bb=["Webkit","O","Moz","ms"],Ab=p.createElement("div").style;c.extend({cssHooks:{opacity:{get:function(a,
...
a.elem.parentNode&&(a.elem[a.prop]=a.now)}};c.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2},_default:"swing"};c.fx=G.prototype.init;c.fx.step={};var ra,Ea,Ic=/^(?:toggle|show|hide)$/,Jc=/queueHooks$/;c.Animation=c.extend(U,{tweeners:{"*":[function(a,b){var c=this.createTween(a,b);kb(c.elem,a,Ja.exec(b),c);return c}]},tweener:function(a,b){c.isFunction(a)?(b=a,a=["*"]):a=a.match(T);for(var d,e=0,f=a.length;e<f;e++)d=a[e],U.tweeners[d]=U.tweeners[d]||[],U.tweeners[d].unshift(b)},
prefilters:[function(a,b,d){var e,f=this,g={},h=a.style,l=a.nodeType&&fa(a),k=c._data(a,"fxshow");if(!d.queue){var n=c._queueHooks(a,"fx");if(null==n.unqueued){n.unqueued=0;var m=n.empty.fire;n.empty.fire=function(){n.unqueued||m()}}n.unqueued++;f.always(function(){f.always(function(){n.unqueued--;c.queue(a,"fx").length||n.empty.fire()})})}if(1===a.nodeType&&("height"in b||"width"in b)){d.overflow=[h.overflow,h.overflowX,h.overflowY];var p=c.css(a,"display");var v="none"===p?c._data(a,"olddisplay")||
pa(a.nodeName):p;"inline"===v&&"none"===c.css(a,"float")&&(q.inlineBlockNeedsLayout&&"inline"!==pa(a.nodeName)?h.zoom=1:h.display="inline-block")}d.overflow&&(h.overflow="hidden",q.shrinkWrapBlocks()||f.always(function(){h.overflow=d.overflow[0];h.overflowX=d.overflow[1];h.overflowY=d.overflow[2]}));for(e in b)if(v=b[e],Ic.exec(v)){delete b[e];var A=A||"toggle"===v;if(v===(l?"hide":"show"))if("show"===v&&k&&void 0!==k[e])l=!0;else continue;g[e]=k&&k[e]||c.style(a,e)}else p=void 0;if(c.isEmptyObject(g))"inline"===
...
(d=f?a.call(this,d,c(this).val()):a,null==d?d="":"number"===typeof d?d+="":c.isArray(d)&&(d=c.map(d,function(a){return null==a?"":a+""})),b=c.valHooks[this.type]||c.valHooks[this.nodeName.toLowerCase()],b&&"set"in b&&void 0!==b.set(this,d,"value")||(this.value=d))})}if(e){if((b=c.valHooks[e.type]||c.valHooks[e.nodeName.toLowerCase()])&&"get"in b&&void 0!==(d=b.get(e,"value")))return d;d=e.value;return"string"===typeof d?d.replace(Kc,""):null==d?"":d}}});c.extend({valHooks:{option:{get:function(a){var b=
c.find.attr(a,"value");return null!=b?b:c.trim(c.text(a)).replace(Lc," ")}},select:{get:function(a){for(var b,d=a.options,e=a.selectedIndex,f=(a="select-one"===a.type||0>e)?null:[],g=a?e+1:d.length,h=0>e?g:a?e:0;h<g;h++)if(b=d[h],!(!b.selected&&h!==e||(q.optDisabled?b.disabled:null!==b.getAttribute("disabled"))||b.parentNode.disabled&&c.nodeName(b.parentNode,"optgroup"))){b=c(b).val();if(a)return b;f.push(b)}return f},set:function(a,b){for(var d,e=a.options,f=c.makeArray(b),g=e.length;g--;)if(b=e[g],
-1<c.inArray(c.valHooks.option.get(b),f))try{b.selected=d=!0}catch(h){b.scrollHeight}else b.selected=!1;d||(a.selectedIndex=-1);return e}}}});c.each(["radio","checkbox"],function(){c.valHooks[this]={set:function(a,b){if(c.isArray(b))return a.checked=-1<c.inArray(c(a).val(),b)}};q.checkOn||(c.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});var F=c.expr.attrHandle,ab=/^(?:checked|selected)$/i,na=q.getSetAttribute,Fa=q.input;c.fn.extend({attr:function(a,b){return H(this,
c.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){c.removeAttr(this,a)})}});c.extend({attr:function(a,b,d){var e,f=a.nodeType;if(3!==f&&8!==f&&2!==f){if("undefined"===typeof a.getAttribute)return c.prop(a,b,d);if(1!==f||!c.isXMLDoc(a)){b=b.toLowerCase();var g=c.attrHooks[b]||(c.expr.match.bool.test(b)?Mc:za)}if(void 0!==d){if(null===d){c.removeAttr(a,b);return}if(g&&"set"in g&&void 0!==(e=g.set(a,d,b)))return e;a.setAttribute(b,d+"");return d}if(g&&"get"in g&&null!==
(e=g.get(a,b)))return e;e=c.find.attr(a,b);return null==e?void 0:e}},attrHooks:{type:{set:function(a,b){if(!q.radioValue&&"radio"===b&&c.nodeName(a,"input")){var d=a.value;a.setAttribute("type",b);d&&(a.value=d);return b}}}},removeAttr:function(a,b){var d=0,e=b&&b.match(T);if(e&&1===a.nodeType)for(;b=e[d++];){var f=c.propFix[b]||b;c.expr.match.bool.test(b)?Fa&&na||!ab.test(b)?a[f]=!1:a[c.camelCase("default-"+b)]=a[f]=!1:c.attr(a,b,"");a.removeAttribute(na?b:f)}}});var Mc={set:function(a,b,d){!1===
b?c.removeAttr(a,d):Fa&&na||!ab.test(d)?a.setAttribute(!na&&c.propFix[d]||d,d):a[c.camelCase("default-"+d)]=a[d]=!0;return d}};c.each(c.expr.match.bool.source.match(/\w+/g),function(a,b){var d=F[b]||c.find.attr;Fa&&na||!ab.test(b)?F[b]=function(a,b,c){if(!c){var e=F[b];F[b]=f;var f=null!=d(a,b,c)?b.toLowerCase():null;F[b]=e}return f}:F[b]=function(a,b,d){if(!d)return a[c.camelCase("default-"+b)]?b.toLowerCase():null}});Fa&&na||(c.attrHooks.value={set:function(a,b,d){if(c.nodeName(a,"input"))a.defaultValue=
b;else return za&&za.set(a,b,d)}});if(!na){var za={set:function(a,b,c){var d=a.getAttributeNode(c);d||a.setAttributeNode(d=a.ownerDocument.createAttribute(c));d.value=b+="";if("value"===c||b===a.getAttribute(c))return b}};F.id=F.name=F.coords=function(a,b,c){var d;if(!c)return(d=a.getAttributeNode(b))&&""!==d.value?d.value:null};c.valHooks.button={get:function(a,b){if((a=a.getAttributeNode(b))&&a.specified)return a.value},set:za.set};c.attrHooks.contenteditable={set:function(a,b,c){za.set(a,""===
b?!1:b,c)}};c.each(["width","height"],function(a,b){c.attrHooks[b]={set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}}})}q.style||(c.attrHooks.style={get:function(a){return a.style.cssText||void 0},set:function(a,b){return a.style.cssText=b+""}});var Nc=/^(?:input|select|textarea|button|object)$/i,Oc=/^(?:a|area)$/i;c.fn.extend({prop:function(a,b){return H(this,c.prop,a,b,1<arguments.length)},removeProp:function(a){a=c.propFix[a]||a;return this.each(function(){try{this[a]=void 0,delete this[a]}catch(b){}})}});
...
/[\t\r\n\f]/g;c.fn.extend({addClass:function(a){var b,d,e,f,g,h=0;if(c.isFunction(a))return this.each(function(b){c(this).addClass(a.call(this,b,V(this)))});if("string"===typeof a&&a)for(b=a.match(T)||[];d=this[h++];){var l=V(d);if(e=1===d.nodeType&&(" "+l+" ").replace(bb," ")){for(g=0;f=b[g++];)0>e.indexOf(" "+f+" ")&&(e+=f+" ");e=c.trim(e);l!==e&&c.attr(d,"class",e)}}return this},removeClass:function(a){var b,d,e,f,g,h=0;if(c.isFunction(a))return this.each(function(b){c(this).removeClass(a.call(this,
b,V(this)))});if(!arguments.length)return this.attr("class","");if("string"===typeof a&&a)for(b=a.match(T)||[];d=this[h++];){var l=V(d);if(e=1===d.nodeType&&(" "+l+" ").replace(bb," ")){for(g=0;f=b[g++];)for(;-1<e.indexOf(" "+f+" ");)e=e.replace(" "+f+" "," ");e=c.trim(e);l!==e&&c.attr(d,"class",e)}}return this},toggleClass:function(a,b){var d=typeof a;return"boolean"===typeof b&&"string"===d?b?this.addClass(a):this.removeClass(a):c.isFunction(a)?this.each(function(d){c(this).toggleClass(a.call(this,
d,V(this),b),b)}):this.each(function(){var b,f;if("string"===d){var g=0;var h=c(this);for(f=a.match(T)||[];b=f[g++];)h.hasClass(b)?h.removeClass(b):h.addClass(b)}else if(void 0===a||"boolean"===d)(b=V(this))&&c._data(this,"__className__",b),c.attr(this,"class",b||!1===a?"":c._data(this,"__className__")||"")})},hasClass:function(a){var b,c=0;for(a=" "+a+" ";b=this[c++];)if(1===b.nodeType&&-1<(" "+V(b)+" ").replace(bb," ").indexOf(a))return!0;return!1}});c.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),
function(a,b){c.fn[b]=function(a,c){return 0<arguments.length?this.on(b,null,a,c):this.trigger(b)}});c.fn.extend({hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});var Pc=m.location,cb=c.now(),db=/\?/,Qc=/(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;c.parseJSON=function(a){if(m.JSON&&m.JSON.parse)return m.JSON.parse(a+"");var b,d=null,e=c.trim(a+"");return e&&!c.trim(e.replace(Qc,function(a,c,e,l){b&&
c&&(d=0);if(0===d)return a;b=e||c;d+=!l-!e;return""}))?Function("return "+e)():c.error("Invalid JSON: "+a)};c.parseXML=function(a){if(!a||"string"!==typeof a)return null;try{if(m.DOMParser){var b=new m.DOMParser;var d=b.parseFromString(a,"text/xml")}else d=new m.ActiveXObject("Microsoft.XMLDOM"),d.async="false",d.loadXML(a)}catch(e){d=void 0}d&&d.documentElement&&!d.getElementsByTagName("parsererror").length||c.error("Invalid XML: "+a);return d};var Rc=/#.*$/,Xb=/([?&])_=[^&]*/,Sc=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,
Tc=/^(?:GET|HEAD)$/,Uc=/^\/\//,Yb=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,Zb={},Qa={},$b="*/".concat("*"),eb=Pc.href,ta=Yb.exec(eb.toLowerCase())||[];c.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:eb,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(ta[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":$b,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",
...
l=void 0;f=e||"";x.readyState=0<a?4:0;e=200<=a&&300>a||304===a;if(d){var r=n;for(var t=x,w,L,z,B,E=r.contents,Q=r.dataTypes;"*"===Q[0];)Q.shift(),void 0===L&&(L=r.mimeType||t.getResponseHeader("Content-Type"));if(L)for(B in E)if(E[B]&&E[B].test(L)){Q.unshift(B);break}if(Q[0]in d)z=Q[0];else{for(B in d){if(!Q[0]||r.converters[B+" "+Q[0]]){z=B;break}w||(w=B)}z=z||w}z?(z!==Q[0]&&Q.unshift(z),r=d[z]):r=void 0}a:{d=n;w=r;L=x;z=e;var H;t={};E=d.dataTypes.slice();if(E[1])for(N in d.converters)t[N.toLowerCase()]=
d.converters[N];for(B=E.shift();B;){d.responseFields[B]&&(L[d.responseFields[B]]=w);!G&&z&&d.dataFilter&&(w=d.dataFilter(w,d.dataType));var G=B;if(B=E.shift())if("*"===B)B=G;else if("*"!==G&&G!==B){var N=t[G+" "+B]||t["* "+B];if(!N)for(H in t)if(r=H.split(" "),r[1]===B&&(N=t[G+" "+r[0]]||t["* "+r[0]])){!0===N?N=t[H]:!0!==t[H]&&(B=r[0],E.unshift(r[1]));break}if(!0!==N)if(N&&d["throws"])w=N(w);else try{w=N(w)}catch(uc){r={state:"parsererror",error:N?uc:"No conversion from "+G+" to "+B};break a}}}r=
{state:"success",data:w}}if(e)if(n.ifModified&&((k=x.getResponseHeader("Last-Modified"))&&(c.lastModified[O]=k),(k=x.getResponseHeader("etag"))&&(c.etag[O]=k)),204===a||"HEAD"===n.type)k="nocontent";else if(304===a)k="notmodified";else{k=r.state;var K=r.data;var J=r.error;e=!J}else if(J=k,a||!k)k="error",0>a&&(a=0);x.status=a;x.statusText=(b||k)+"";e?v.resolveWith(p,[K,k,x]):v.rejectWith(p,[x,k,J]);x.statusCode(C);C=void 0;h&&q.trigger(e?"ajaxSuccess":"ajaxError",[x,n,e?K:J]);A.fireWith(p,[x,k]);
h&&(q.trigger("ajaxComplete",[x,n]),--c.active||c.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var e,f,g,h,l,k,n=c.ajaxSetup({},b),p=n.context||n,q=n.context&&(p.nodeType||p.jquery)?c(p):c.event,v=c.Deferred(),A=c.Callbacks("once memory"),C=n.statusCode||{},E={},H={},F=0,G="canceled",x={readyState:0,getResponseHeader:function(a){var b;if(2===F){if(!k)for(k={};b=Sc.exec(f);)k[b[1].toLowerCase()]=b[2];b=k[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===
F?f:null},setRequestHeader:function(a,b){var c=a.toLowerCase();F||(a=H[c]=H[c]||a,E[a]=b);return this},overrideMimeType:function(a){F||(n.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>F)for(b in a)C[b]=[C[b],a[b]];else x.always(a[x.status]);return this},abort:function(a){a=a||G;l&&l.abort(a);d(0,a);return this}};v.promise(x).complete=A.add;x.success=x.done;x.error=x.fail;n.url=((a||n.url||eb)+"").replace(Rc,"").replace(Uc,ta[1]+"//");n.type=b.method||b.type||n.method||n.type;n.dataTypes=
c.trim(n.dataType||"*").toLowerCase().match(T)||[""];null==n.crossDomain&&(a=Yb.exec(n.url.toLowerCase()),n.crossDomain=!(!a||a[1]===ta[1]&&a[2]===ta[2]&&(a[3]||("http:"===a[1]?"80":"443"))===(ta[3]||("http:"===ta[1]?"80":"443"))));n.data&&n.processData&&"string"!==typeof n.data&&(n.data=c.param(n.data,n.traditional));Jb(Zb,n,b,x);if(2===F)return x;(h=c.event&&n.global)&&0===c.active++&&c.event.trigger("ajaxStart");n.type=n.type.toUpperCase();n.hasContent=!Tc.test(n.type);var O=n.url;n.hasContent||
(n.data&&(O=n.url+=(db.test(O)?"&":"?")+n.data,delete n.data),!1===n.cache&&(n.url=Xb.test(O)?O.replace(Xb,"$1_="+cb++):O+(db.test(O)?"&":"?")+"_="+cb++));n.ifModified&&(c.lastModified[O]&&x.setRequestHeader("If-Modified-Since",c.lastModified[O]),c.etag[O]&&x.setRequestHeader("If-None-Match",c.etag[O]));(n.data&&n.hasContent&&!1!==n.contentType||b.contentType)&&x.setRequestHeader("Content-Type",n.contentType);x.setRequestHeader("Accept",n.dataTypes[0]&&n.accepts[n.dataTypes[0]]?n.accepts[n.dataTypes[0]]+
("*"!==n.dataTypes[0]?", "+$b+"; q=0.01":""):n.accepts["*"]);for(e in n.headers)x.setRequestHeader(e,n.headers[e]);if(n.beforeSend&&(!1===n.beforeSend.call(p,x,n)||2===F))return x.abort();G="abort";for(e in{success:1,error:1,complete:1})x[e](n[e]);if(l=Jb(Qa,n,b,x)){x.readyState=1;h&&q.trigger("ajaxSend",[x,n]);if(2===F)return x;n.async&&0<n.timeout&&(g=m.setTimeout(function(){x.abort("timeout")},n.timeout));try{F=1,l.send(E,d)}catch(L){if(2>F)d(-1,L);else throw L;}}else d(-1,"No Transport");return x},
...
a.call(this,d):a)})},unwrap:function(){return this.parent().each(function(){c.nodeName(this,"body")||c(this).replaceWith(this.childNodes)}).end()}});c.expr.filters.hidden=function(a){return q.reliableHiddenOffsets()?0>=a.offsetWidth&&0>=a.offsetHeight&&!a.getClientRects().length:nc(a)};c.expr.filters.visible=function(a){return!c.expr.filters.hidden(a)};var Vc=/%20/g,oc=/\[\]$/,ac=/\r?\n/g,Wc=/^(?:submit|button|image|reset|file)$/i,Xc=/^(?:input|select|textarea|keygen)/i;c.param=function(a,b){var d,
e=[],f=function(a,b){b=c.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};void 0===b&&(b=c.ajaxSettings&&c.ajaxSettings.traditional);if(c.isArray(a)||a.jquery&&!c.isPlainObject(a))c.each(a,function(){f(this.name,this.value)});else for(d in a)Sa(d,a[d],b,f);return e.join("&").replace(Vc,"+")};c.fn.extend({serialize:function(){return c.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=c.prop(this,"elements");return a?
c.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!c(this).is(":disabled")&&Xc.test(this.nodeName)&&!Wc.test(a)&&(this.checked||!La.test(a))}).map(function(a,b){a=c(this).val();return null==a?null:c.isArray(a)?c.map(a,function(a){return{name:b.name,value:a.replace(ac,"\r\n")}}):{name:b.name,value:a.replace(ac,"\r\n")}}).get()}});c.ajaxSettings.xhr=void 0!==m.ActiveXObject?function(){return this.isLocal?Kb():8<p.documentMode?Ta():/^(get|post|head|put|delete|options)$/i.test(this.type)&&
...
(d["X-Requested-With"]="XMLHttpRequest");for(f in d)void 0!==d[f]&&g.setRequestHeader(f,d[f]+"");g.send(a.hasContent&&a.data||null);b=function(d,f){if(b&&(f||4===g.readyState))if(delete Ga[h],b=void 0,g.onreadystatechange=c.noop,f)4!==g.readyState&&g.abort();else{var k={};var l=g.status;"string"===typeof g.responseText&&(k.text=g.responseText);try{var m=g.statusText}catch(Ma){m=""}l||!a.isLocal||a.crossDomain?1223===l&&(l=204):l=k.text?200:404}k&&e(l,m,k,g.getAllResponseHeaders())};a.async?4===g.readyState?
m.setTimeout(b):g.onreadystatechange=Ga[h]=b:b()},abort:function(){b&&b(void 0,!0)}}}});c.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/\b(?:java|ecma)script\b/},converters:{"text script":function(a){c.globalEval(a);return a}}});c.ajaxPrefilter("script",function(a){void 0===a.cache&&(a.cache=!1);a.crossDomain&&(a.type="GET",a.global=!1)});c.ajaxTransport("script",function(a){if(a.crossDomain){var b,d=p.head||
c("head")[0]||p.documentElement;return{send:function(c,f){b=p.createElement("script");b.async=!0;a.scriptCharset&&(b.charset=a.scriptCharset);b.src=a.url;b.onload=b.onreadystatechange=function(a,c){if(c||!b.readyState||/loaded|complete/.test(b.readyState))b.onload=b.onreadystatechange=null,b.parentNode&&b.parentNode.removeChild(b),b=null,c||f(200,"success")};d.insertBefore(b,d.firstChild)},abort:function(){if(b)b.onload(void 0,!0)}}}});var bc=[],fb=/(=)\?(?=&|$)|\?\?/;c.ajaxSetup({jsonp:"callback",
...
g);a.converters["script json"]=function(){e||c.error(g+" was not called");return e[0]};a.dataTypes[0]="json";var h=m[g];m[g]=function(){e=arguments};d.always(function(){void 0===h?c(m).removeProp(g):m[g]=h;a[g]&&(a.jsonpCallback=b.jsonpCallback,bc.push(g));e&&c.isFunction(h)&&h(e[0]);e=h=void 0});return"script"}});c.parseHTML=function(a,b,d){if(!a||"string"!==typeof a)return null;"boolean"===typeof b&&(d=b,b=!1);b=b||p;var e=Pb.exec(a);d=!d&&[];if(e)return[b.createElement(e[1])];e=mb([a],b,d);d&&
d.length&&c(d).remove();return c.merge([],e.childNodes)};var cc=c.fn.load;c.fn.load=function(a,b,d){if("string"!==typeof a&&cc)return cc.apply(this,arguments);var e,f,g=this,h=a.indexOf(" ");if(-1<h){var l=c.trim(a.slice(h,a.length));a=a.slice(0,h)}c.isFunction(b)?(d=b,b=void 0):b&&"object"===typeof b&&(e="POST");0<g.length&&c.ajax({url:a,type:e||"GET",dataType:"html",data:b}).done(function(a){f=arguments;g.html(l?c("<div>").append(c.parseHTML(a)).find(l):a)}).always(d&&function(a,b){g.each(function(){d.apply(this,
...
a[e]=h},a,e,arguments.length,null)}});c.each(["top","left"],function(a,b){c.cssHooks[b]=Pa(q.pixelPosition,function(a,e){if(e)return e=ha(a,b),ia.test(e)?c(a).position()[b]+"px":e})});c.each({Height:"height",Width:"width"},function(a,b){c.each({padding:"inner"+a,content:b,"":"outer"+a},function(d,e){c.fn[e]=function(e,g){var f=arguments.length&&(d||"boolean"!==typeof e),l=d||(!0===e||!0===g?"margin":"border");return H(this,function(b,d,e){return c.isWindow(b)?b.document.documentElement["client"+a]:
...
c.fn.addBack;"function"===typeof define&&define.amd&&define("jquery",[],function(){return c});var Zc=m.jQuery,$c=m.$;c.noConflict=function(a){m.$===c&&(m.$=$c);a&&m.jQuery===c&&(m.jQuery=Zc);return c};v||(m.jQuery=m.$=c);return c});
