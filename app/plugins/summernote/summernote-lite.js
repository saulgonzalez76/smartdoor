  ...
  Toolbar_createClass(Toolbar, [{
    ...
    value: function initialize() {
      ...
      if (!this.options.toolbar.length) {
        ...
        this.context.invoke('buttons.build_borrar', this.$toolbar, this.options.toolbar);
      }
...
function () {
  ...
  LinkPopover_createClass(LinkPopover, [{
    ...
    value: function initialize() {
      ...
      this.context.invoke('buttons.build_borrar', $content, this.options.popover.link);
...
function () {
  ...
  ImagePopover_createClass(ImagePopover, [{
    ...
    value: function initialize() {
      ...
      var $content = this.$popover.find('.popover-content,.note-popover-content');
      this.context.invoke('buttons.build_borrar', $content, this.options.popover.image);
      this.$popover.on('mousedown', function (e) {
        e.preventDefault();
      });
    }
...
function () {
  ...
  TablePopover_createClass(TablePopover, [{
    ...
    value: function initialize() {
      ...
      var $content = this.$popover.find('.popover-content,.note-popover-content');
      this.context.invoke('buttons.build_borrar', $content, this.options.popover.table); // [workaround] Disable Firefox's default table editor
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function show() {
      ...
      this.showVideoDialog(text).then(function (url) {
        ...
        _this.context.invoke('editor.restoreRange'); // build_borrar node
...
function () {
  ...
  AirPopover_createClass(AirPopover, [{
    ...
    value: function initialize() {
      ...
      this.context.invoke('buttons.build_borrar', $content, this.options.popover.air); // disable hiding this popover preemptively by 'summernote.blur' event.
