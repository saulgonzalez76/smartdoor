jquery.flot.time.min.js:6: WARNING - [JSC_SUSPICIOUS_SEMICOLON] If this if/for/while really shouldn't have a body, use {}
...
f=h.tickSize[0]*d[h.tickSize[1]];h=h.max-h.min;var e=g.twelveHourClock?" %p":"",a=g.twelveHourClock?"%I":"%H";return r(c,f<d.minute?a+":%M:%S"+e:f<d.day?h<2*d.day?a+":%M"+e:"%b %d "+a+":%M"+e:f<d.month?"%b %d":b&&f<d.quarter||!b&&f<d.year?h<d.year?"%b":"%b %Y":b&&f<d.year?h<d.year?"Q%q":"Q%q %Y":"%Y",g.monthNames,g.dayNames)})})})},options:{xaxis:{timezone:null,timeformat:null,twelveHourClock:!1,monthNames:null}},name:"time",version:"1.0"});p.plot.formatDate=r})(jQuery);
