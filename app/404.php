...
<body class="text-center" style="background-color:  #01052d;">
    <div style="height: 400px;">
        <img style="max-width: 100%; max-height: 100%; display: block;" src="<?= $siteUrl; ?>/common_files/img/logo.png">
    </div>
    <label style="color: white;">Ups, no encontramos lo que buscas !</label>
