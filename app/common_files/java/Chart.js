...
(function(){
    ...
    Chart.Scale = Chart.Element.extend({
        ...
        fit: function(){
            ...
            // With these properties set we can now build_borrar the array of yLabels
...
(function(){
    ...
    Chart.Type.extend({
        ...
        initialize:  function(data){
            ...
            //Iterate through each of the datasets, and build_borrar this into a property of the chart
